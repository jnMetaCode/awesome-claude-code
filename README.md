...
- [Agency Agents 中文版](https://github.com/jnMetaCode/agency-agents-zh) by [jnMetaCode](https://github.com/jnMetaCode) - 186 ready-to-use AI expert personas covering 17 departments — from product management to legal to game design. Each role is a structured markdown file with expertise frameworks, communication style, and domain knowledge. Works with Claude Code, Cursor, OpenClaw, and 8 other tools.
...
- [Superpowers 中文版](https://github.com/jnMetaCode/superpowers-zh) by [jnMetaCode](https://github.com/jnMetaCode) - Complete Chinese translation of Superpowers with 5 original China-specific skills (Gitee/Coding workflows, Chinese typography, MCP building). Supports Claude Code, Cursor, Codex, Kiro, DeerFlow, Trae, Antigravity, and VS Code.
...
- [Agency Orchestrator](https://github.com/jnMetaCode/agency-orchestrator) by [jnMetaCode](https://github.com/jnMetaCode) - YAML-first multi-agent workflow engine with 186 ready-to-use AI roles. Define collaborations in YAML with auto DAG parallelism, condition branching, loops, and `--resume` for iterative optimization. Works inside Claude Code without API keys (skill mode) or standalone with DeepSeek/Claude/OpenAI/Ollama. Two npm dependencies, zero Python.
...
- [Dippy](https://github.com/ldayton/Dippy) by [Lily Dayton](https://github.com/ldayton) - Auto-approve safe bash commands using AST-based parsing, while prompting for destructive operations. Solves permission fatigue without disabling safety. Supports Claude Code, Gemini CLI, and Cursor.
- [parry](https://github.com/vaporif/parry) by [Dmytro Onypko](https://github.com/vaporif) - Prompt injection scanner for Claude Code hooks. Scans tool inputs and outputs for injection attacks, secrets, and data exfiltration attempts. [NOTE: Early development phase but worth a look.].
- [ShellWard](https://github.com/jnMetaCode/shellward) by [jnMetaCode](https://github.com/jnMetaCode) - AI agent security middleware with 8-layer defense: prompt injection detection (32+ rules, Chinese + English), PII scanning (Chinese ID/phone/bank cards + global), command safety checks, DLP data flow tracking, and path protection. Zero dependencies. Available as MCP server, SDK, or Claude Code hook.
